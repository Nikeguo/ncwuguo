...
function showWelcome() {
    ...
    let dist = getDistance(110.496463, 19.938790, ipLocation.data.lng, ipLocation.data.lat); //改为自己的经纬度，写法121.413921（经度lng）,31.089290（纬度lat），不清楚的可以在网页打开地址 https://api.qjqq.cn/api/Local，根据返回的数据对比填写
